...
def request_investment():
    ...
    btc_address = data.get('btc_address') # This would normally be generated by backend
    ...
    notification = Notification(
        user_id=user_id,
        message=f"Created investment request for {amount_btc} BTC. Pending confirmation.",
        type='info'
    )
